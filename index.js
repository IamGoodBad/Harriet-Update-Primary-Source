...
exports.updatePrimarySource = function updatePrimarySource(req, res) {
  ...
  .then(verifyIdToken)
  .then(getCustomerId)
  .then(updateCustomerPrimarySource)
...
var updateCustomerPrimarySource = function(request) {
  return stripe.customers.update(request.body.customerID, {default_source: request.body.source})
